...
const Loans = () => {
  ...
  const loanStats = {
    ...
    totalAmount: allLoans.filter((l) => l.loan_status === "active" || l.loan_status === "completed").reduce((sum, l) => sum + l.loan_amount, 0),
    totalunpaid: allLoans.filter((l) => l.loan_status === "active").reduce((sum, l) => sum + (l.loan_balance ||0), 0)
  };
                        ...
                        <tr key={loan.loan_id} className="border-b border-border/50 hover:bg-muted/20 transition-colors">
                          ...
                          <td className="px-4 py-3">
                            <Select
                              ...
                              disabled={updatingLoanId === loan.loan_id || loan.loan_status === "completed" || loan.loan_status === "cancelled"}
                            >
